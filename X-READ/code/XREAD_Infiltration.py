...
test_set = test_datagen.flow_from_directory(
    'C:/Users/1439208/CNNTest/dataset/infiltration_test_set',
    target_size=(64, 64),
    batch_size=32,
    class_mode='binary')
...
classifier.save('InfiltrationRemote.h5')
...
if result[0][0] >= 0.5:
    ...
    prediction = 'Infiltration Detected'
print(prediction)

if mass_result[0][0] >= 0.5:
    new_prediction = 'No Finding'
else:
    new_prediction = 'Infiltration Detected'
print(prediction)