# -*- coding: utf-8 -*-
"""
Created on Thu Dec  5 12:50:20 2019
...
training_set  =train_datagen.flow_from_directory(
    'C:/Users/1439208/CNNTest/dataset/atelectasis_training_set',
    target_size=(64, 64),
    batch_size=32,
    class_mode='binary')

test_set = test_datagen.flow_from_directory(
    'C:/Users/1439208/CNNTest/dataset/atelectasis_test_set',
    target_size=(64, 64),
    batch_size=32,
    class_mode='binary')
...
classifier.save('AtelectasisRemote.h5')
...
if result[0][0] >= 0.5:
    ...
    prediction = 'Atelectasis Detected'
print(prediction)

if mass_result[0][0] >= 0.5:
    new_prediction = 'No Finding'
else:
    new_prediction = 'Atelectasis Detected'
print(prediction)